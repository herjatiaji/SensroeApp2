package com.example.sensroeapp2;
...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private TextView mTextSensroAzimuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextSensroAzimuth = findViewById(R.id.value_azimuth);
        ...
        mSpotlLeft = findViewById(R.id.spot_left);
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        mTextSensroAzimuth.setText(getResources().getString(R.string.value_format,azimuth));
